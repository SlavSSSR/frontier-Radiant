...
bounty-contracts-announcement-radio-name = Услуги заключения контрактов
bounty-contracts-announcement-pda-name = Контракт создан

bounty-contracts-announcement-generic-create = Размещен новый контракт {$target}. Вознаграждение: {$reward}.
bounty-contracts-announcement-criminal-create = Назначена награда за {$target}. Вознаграждение: {$reward}.
bounty-contracts-announcement-vacancy-create = Открыта новая вакансия {$target}. Вознаграждение: {$reward}.
bounty-contracts-announcement-construction-create = Новый контракт на строительство {$target}. Вознаграждение: {$reward}.
bounty-contracts-announcement-service-create = Была размещена услуга {$target}. Вознаграждение: {$reward}.

## Contract collection names
bounty-contract-collection-name-command = Командование
bounty-contract-collection-name-public = Общественные
...
bounty-contracts-ui-list-author = Опубликовал: {$author}
...
bounty-contracts-ui-create-vessel-placeholder = Название объекта...
